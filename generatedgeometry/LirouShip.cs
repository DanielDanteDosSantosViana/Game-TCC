...
namespace Ship
{
    ...
    class LirouShip : CObject
    {
        ...
        float moveSpeed, maxSpeed = 15.0f, acceleration = 0.08f, rotatingSpeed;
        Matrix modelMatrix;
        Vector3 velocity;
        ...
        public void Update(float terrainScale,KeyboardState kb, Camera camera, List<CObject> cobjects)
        {
            ...
            {
                if (moveSpeed + acceleration  == Constants.ZERO)
                {
                    moveSpeed = 0;
                }
                else
        ...
        public void restartPos()
        {
            ...
            public bool getCollision(ref CObject m2, Matrix w1, Matrix w2)
            {
                    ...
                    CObject m1 = this;
                    if (m2 != this && isCollidingBS(ref m1, w1, ref m2, w2)  )
                    {
                        //Console.WriteLine("PASSOU AQUI" + cobject + this);
